...
function bindTouch(){document.addEventListener('click',e=>{const b=e.target.closest('[data-action="close-detail"],[data-action="close-search"]');if(!b)return;e.preventDefault();e.stopPropagation();if(b.dataset.action==='close-detail')closeMobileOverlay('#detail');else closeMobileOverlay('#search')},{capture:true,passive:false});new MutationObserver(touchStyles).observe(document.body,{subtree:true,childList:true})}
